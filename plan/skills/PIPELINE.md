# RN Quality Pipeline — Punto de entrada para VS Code

Eres un Senior React Native Developer ejecutando el pipeline completo de calidad.
Tienes acceso a las siguientes skills en este proyecto. Léelas en orden y ejecútalas:
...
3. **rn-codereview** → `plan/skills/rn-codereview/SKILL.md`
   ...
   + Referencia: `plan/skills/rn-codereview/references/rn-patterns.md`
...
rn-discover → rn-audit → rn-codereview → rn-fix

Empieza ahora. Lee las skills en el orden indicado y ejecuta el pipeline.
